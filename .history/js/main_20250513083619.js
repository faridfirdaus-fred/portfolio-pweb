...
// Logo animation on scroll let animationInProgress = false;
...
$(document).ready(function() {
  ...
  function handleScrollForLogo() {
    ...
    if (scrollY > triggerPoint && !animationInProgress) {
      animateLogo();
    }
  }
  ...
  function animateLogo() {
    ...
    setTimeout(() => {
      floatingLogo.style.width = `${navbarLogoRect.width}px`;
      floatingLogo.style.height = `${navbarLogoRect.height}px`;
      floatingLogo.style.top = `${navbarLogoRect.top + window.scrollY}px`;
      floatingLogo.style.left = `${navbarLogoRect.left}px`;
