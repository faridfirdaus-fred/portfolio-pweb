...
// Clean up any existing logo animation code and replace with this
...
$(document).ready(function() {
  ...
  window.addEventListener('scroll', function() {
    ...
    if (scrollY > triggerPoint) {
      ...
      const currentTop = initialTop + (targetTop - initialTop) * scrollProgress;
...
// Remove any conflicting functions
// Delete or comment out all resetLogoState functions
