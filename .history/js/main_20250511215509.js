...
function loadWorkItems() {
  $.ajax({
      ...
      works.forEach((work) => {
        html += `
                    <div class="col-md-4 work-item" data-category="${work.category}">
                        <div class="card">
                            <img src="uploads/${work.image}" class="card-img-top" alt="${work.title}">
                            <div class="card-body">
    ...
    error: (error) => {
      ...
      $("#work-gallery").html('<p class="text-center">Failed to load work items.</p>')
    },
  })
}
...
function loadTestimonials() {
  $.ajax({
                    ...
                    <div class="col-md-4">
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-author">
                                <img src="uploads/${testimonial.image}" alt="${testimonial.name}">
    ...
    error: (error) => {
      ...
      $("#testimonials-container").html('<p class="text-center">Failed to load testimonials.</p>')
    },
  })
}
