...
$(document).ready(function() {
  ...
  function animateLogo() {
    ...
    setTimeout(() => {
      ...
      const originalAspectRatio = heroLogoRect.width / heroLogoRect.height;
      ...
      floatingLogo.style.height = `${targetHeight}px`;
      floatingLogo.style.top = `${
        updatedNavbarLogoRect.top + window.scrollY
      }px`;
      floatingLogo.style.left = `${updatedNavbarLogoRect.left}px`;

      // After animation completes - ADD THIS CODE
      setTimeout(() => {
...
// KEEP ONLY THIS ONE resetLogoState function and REMOVE the duplicate one
